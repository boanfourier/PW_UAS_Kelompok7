<template>
    <div>
        <div class="jumbotron text-center">
            ...
            <p class="lead">
                Adalah Website untuk forum untuk pengaduan barang hilang
            </p>
            <hr class="my-4" />
        ...
        <footer>
            <div class="bg-secondary p-5 mt-5">
                <div class="row">
                    <div class="col-lg-6">
                        <h1 class="text-white">E-Laporz</h1>
                        <p class="text-white">
                            Adalah Website untuk forum untuk pengaduan barang
                            hilang
                        </p>
                    </div>
                    <div class="col-lg-6">
                        <h2 class="text-white text-right">Kontak Kami</h2>

                        <div class="float-right">
                            <a href="" class="text-white"
                                ><i class="fab fa-instagram"></i> @e_laporz</a
                            >
                            <br />
                            <a href="" class="text-white"
            ...
            <div class="bg-dark p-2">
                <p class="text-center text-white mt-2">
                    <i class="fa fa-copyright"></i> Copyright by Kelompok 7
                </p>
            </div>
        </footer>
    </div>
